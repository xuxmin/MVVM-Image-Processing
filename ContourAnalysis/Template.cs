...
{
    //The class Template is used for creation of base of templates. 
    //This class stores a contour, it ACF, descriptors ACF, the linear parameters of an initial contour (area), 
    //norm of a contour. Also, the template has a name which is used as the recognized value.
    [Serializable]
    public class Template
    {
        ...
        public Contour autoCorr;     //normalize的ACF
        public Point startPoint;     //contour的起始点
        ...
        public double contourNorma;  //contour的长度(模)
        ...
        /// <param name="sourceArea">轮廓的面积</param>
        /// <param name="templateSize">组成contour的EV的个数，已经默认初始化成30</param>
        public Template(Point[] points, double sourceArea, int templateSize)
        {
            ...
            CalcAutoCorrDescriptions();   //将ACF与特定的数字对应起来
        }
